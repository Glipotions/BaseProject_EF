...
namespace UI.Win.Forms.FiltreForms
{
	partial class FiltreListForm
	{
		...
		private void InitializeComponent()
		{
			...
			this.longNavigator = new UI.Win.UserControls.Navigators.LongNavigator();
			this.grid = new UI.Win.UserControls.Grid.MyGridControl();
			this.tablo = new UI.Win.UserControls.Grid.MyGridView();
			this.colId = new UI.Win.UserControls.Grid.MyGridColumn();
			this.colKod = new UI.Win.UserControls.Grid.MyGridColumn();
			this.colFiltreAdi = new UI.Win.UserControls.Grid.MyGridColumn();
