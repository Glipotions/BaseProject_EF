...
namespace UI.Win.Forms.FiltreForms
{
	partial class FiltreEditForm
	{
		...
		private void InitializeComponent()
		{
			...
			this.myDataLayoutControl = new UI.Win.UserControls.Controls.MyDataLayoutControl();
			this.txtFiltreMetni = new UI.Win.UserControls.Controls.MyFilterControl();
			this.txtFiltreAdi = new UI.Win.UserControls.Controls.MyTextEdit();
			this.txtKod = new UI.Win.UserControls.Controls.MyCodeTextEdit();
